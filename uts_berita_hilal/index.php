...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top mb-4">
        <div class="container">
            <a class="navbar-brand" href="index.php"><i class="bi bi-lightning-fill text-danger"></i> BERITA</a>
            <div class="d-flex align-items-center">
                <form action="index.php" method="GET" class="d-none d-md-flex me-3">
                    <div class="input-group">
                        <input type="text" name="cari" class="form-control form-control-sm border-0 bg-light" placeholder="Cari berita...">
    ...
    <div class="container">
        <div class="hero-section shadow">
            <div>
                ...
                <h2 class="fw-bold">Selamat Datang di Portal Berita Hilal</h2>
                <p class="mb-0">Dapatkan informasi teknologi dan gadget terbaru setiap hari.</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <h4 class="sidebar-title">
                    <?= isset($_GET['cari']) ? "Hasil Pencarian: '".htmlspecialchars($_GET['cari'])."'" : "Berita Terbaru" ?>
                </h4>
                ...
                <div class="row">
                    ...
                    if(mysqli_num_rows($sql) == 0) echo "<div class='col-12'><p class='alert alert-warning'>Wah, berita nggak ketemu nih.</p></div>";
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        while($k = mysqli_fetch_array($kat)) {
                            echo "<a href='#' class='btn btn-white shadow-sm btn-sm border rounded-pill px-3'>#$k[nama_kategori]</a>";
                        }
                        ?>
                    </div>
                </div>
    ...
    <footer>
        <div class="container text-center">
            <h5 class="fw-bold mb-3">BERITA HILAL</h5>
